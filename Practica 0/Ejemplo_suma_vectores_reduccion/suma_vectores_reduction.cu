...
/*
Ejercicio: a partir de este algoritmo, pero que se lancen la mitad de hebras, 
(en vez de N hebras, N/2 hebras) porque de primeras cada hebra coge un dato de 
cada mitad del vector, opera con ellos, y guarda ese dato en el vector compartido.

Comparar tiempos con con kernel original (N hebras) y modificado (n/2 hebras)
*/
